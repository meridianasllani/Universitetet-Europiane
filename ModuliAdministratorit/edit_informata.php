...
{	
	...
	if(empty($titulli) || empty($pershkrimi)) {	
		...
		$result = mysqli_query($con,"CALL EDITINFORMATA('$informata_info_ue_ID','$imgData','$titulli','$pershkrimi')");
...
?>
<?php
//getting informata_info_ue_ID from url
$informata_info_ue_ID = $_GET['informata_info_ue_ID'];

//selecting data associated with this particular informata_info_ue_ID
mysqli_next_result($con);
$result = mysqli_query($con,"CALL ZGJEDHINFORMATA('$informata_info_ue_ID')");

while($res = mysqli_fetch_array($result))
{
	$imgData = $res['foto_info_ue'];
	$titulli = $res['titulli_info_ue'];
	$pershkrimi = $res['pershkrimi_info_ue'];
}
?>
