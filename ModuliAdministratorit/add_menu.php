<?php include("check.php");?><?php include ("header_admin.php");
...
if(isset($_POST['add'])) {	
	...
	if(empty($emri) || empty($link) || empty($moduli)) {
		...
		$result = mysqli_query($con, "CALL INSERTMENU('$emri','$link','$moduli')");
			echo "<script>
         setTimeout(function(){
										...
										<form method="post" action="#" enctype="multipart/form-data">
											<div class="row uniform">
												<div align="center"class="6u 12u$(xsmall)">
													<input type="text" name="emri" id="name" value="" placeholder="Emri i Menyse" />
												</div>
												<div align="center"class="6u 12u$(xsmall)">
													<input type="text" name="link" id="name" value="" placeholder="Linku i Menyse" />
												</div>
												<div align="center"class="6u 12u$(xsmall)">
													<input type="text" name="moduli" id="name" value="" placeholder="Moduli" />
												</div>
												<div class="12u$">
													<ul class="actions">
